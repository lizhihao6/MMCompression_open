...
class PatchEmbed(nn.Module):
    """
    This class is used to embed the patch into a vector.
    """
...
class PatchUnEmbed(nn.Module):
    """
    This class is used to unembed the vector into a patch.
    """
...
class WindowAttention(nn.Module):
    ...
    def extra_repr(self) -> str:
        """
        Extra information for PyTorch's repr.
        """
...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, x_size):
        ...
        # W-MSA/SW-MSA
        # (to be compatible for testing on images whose shapes are the multiple of window size
    ...
    def extra_repr(self) -> str:
        """
        Extra information for the __str__ representation.
        """
        return (
            f"dim={self.dim}, "
